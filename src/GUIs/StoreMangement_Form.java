...
public class StoreMangement_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable_ItemsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Name", "Item ID", "Category", "Aisle", "Description", "Size", "Price", "Sale", "Availability"
            }
        ) {
    ...
    private void jTable_ItemsTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_ItemsTableMouseClicked
        ...
        String category = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 2).toString();
        String aisle = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 3).toString();
        String description = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 4).toString();
        String size = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 5).toString();
        String price = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 6).toString();
        String sale = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 7).toString();
        String itemAvailability = itemModel.getValueAt(jTable_ItemsTable.getSelectedRow(), 8).toString();
